// STYLE SHEET EXAMPLE
// This is a style guide for C# code in Unity. It covers naming conventions, formatting, comments, and more.
...
/// </remarks>
{
    ...
    {
        private string damageTypeName { get; }
        private float damageValue { get; }

        // METHODS:
        // - Start a methods name with a verbs or verb phrases to show an action.
        // - Parameter names are camelCase.
        private bool ApplyDamage(string description, float damage, int numberOfHits);
    }

    public interface IDamageable<T>
    {
        private void Damage(T damageTaken);
    }
    ...
    public class StyleExample : MonoBehaviour
    {
        ...
        private void FormatExamples(int someExpression)
        {
            ...
            // - Braces for return statements are optional.
            if (isDead) return;
        }
